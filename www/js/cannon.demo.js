...
CANNON.Demo = function(options) {
    ...
    var contactDotMaterial = new THREE.MeshPhongMaterial({
        color: 0xff0000
    });
    ...
    var axesMeshCache = new GeometryCache(function() {
        ...
        var lineX = new THREE.Line(gX, new THREE.LineBasicMaterial({
            color: 0xff0000
        }));
        var lineY = new THREE.Line(gY, new THREE.LineBasicMaterial({
            color: 0x00ff00
        }));
        var lineZ = new THREE.Line(gZ, new THREE.LineBasicMaterial({
            color: 0x0000ff
        }));
        mesh.add(lineX);
        mesh.add(lineY);
    ...
    function init() {
        ...
        s_oRayCasterMesh = new THREE.Mesh(oPlaneGeometry, new THREE.MeshLambertMaterial({
